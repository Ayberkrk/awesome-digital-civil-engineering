...
- [turkiye-heat-risk](https://github.com/Ayberkrk/turkiye-heat-risk#readme) - City independent, reproducible urban heat risk pipeline that combines Landsat land surface temperature, OpenStreetMap road network and demographic data into a street level heat sensitivity index. Currently supports Izmir, Eskisehir and Sanliurfa.
